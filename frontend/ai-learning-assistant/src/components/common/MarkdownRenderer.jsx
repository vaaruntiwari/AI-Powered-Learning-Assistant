      ...
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ node, ...props }) => (
            <blockquote className="border-l-4 border-neutral-300 pl-4 italic text-neutral-700 my-2" {...props} />
          ),
          code: ({ node, inline, className, children, ...props }) => {
            ...
            return !inline && match ? (
              ...
              <code className="bg-neutral-100 rounded px-1 font-mono text-sm" {...props}>
                {children}
              </code>
            );
          },
