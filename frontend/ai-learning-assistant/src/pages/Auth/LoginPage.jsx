...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white-to-slate-50">
      <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,tansparent_1px)] bg-size-[16px_16px] opacity-30" />
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3x shadow-3xl shadow-xl shadow-slate-200/50 p-10">
          {/* Header */}
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/60">
            <p className="text-center text-sm tet-slate-600">
              Don't have an account?{' '}
              <Link to="/register" className="font-semibold text-emerald-600 hover:text-emerald-700 transition-color duration-200">
                Sign up
              </Link>
            </p>
          </div>

          {/* Subtle Terms / Privacy Disclaimer */}
